...
import 'package:invoice_generator/view/screens/utills/globals.dart';
...
Future<Uint8List> getPdf({required Size size}) async {
  final ByteData byteData = await rootBundle.load("assets/images/logo_bk.png");
